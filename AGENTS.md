...
Norbi's wargaming website aimed at an international audience. Working language with Norbi is Hungarian (personal project), but the site itself is in English. AGENTS.md files are always written in English (standing rule).
